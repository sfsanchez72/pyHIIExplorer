...
def extracting_flux_elines(name, data, hdr_fe, blobs_final, diff_points, plot=0, def_DIG=0, cube_DIG=np.array):
...
def extracting_ssp(name, data_SSP, hdr_ssp, WCS, blobs_final, diff_points, plot=0):
...
def extracting_sfh(name, data_SFH, hdr_sfh, WCS, blobs_final, diff_points, plot=0):
...
def extracting_index(name, data_INDEX, hdr_index, WCS, blobs_final, diff_points, plot=0):
