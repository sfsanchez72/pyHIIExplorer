...
table_HII.write(file_table_HII, overwrite=True, compression=True, path=DIR)
table_DIG.write(file_table_DIG, overwrite=True, compression=True, path=DIR)
...
table_SSP_HII.write(file_table_SSP_HII, overwrite=True, compression=True, path=DIR)
table_SSP_DIG.write(file_table_SSP_DIG, overwrite=True, compression=True, path=DIR)
...
table_SFH_HII.write(file_table_SFH_HII, overwrite=True, compression=True, path=DIR)
table_SFH_DIG.write(file_table_SFH_DIG, overwrite=True, compression=True, path=DIR)
...
table_INDEX_HII.write(file_table_INDEX_HII, overwrite=True, compression=True, path=DIR)
table_INDEX_DIG.write(file_table_INDEX_DIG, overwrite=True, compression=True, path=DIR)
