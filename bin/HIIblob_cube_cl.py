...
parser = argparse.ArgumentParser(description='###Program to detect HII regions from a cube###', usage='HIIblob_cube_cl.py name input_file n_hdu n_Ha n_eHa FWHM_MUSE spax_sca MUSE_1sig MUSE_1sig_V plot refined maps_seg DIG_type_weight DIR [--OPTIONAL_ARGUMENTS=*]\nRun with -h for details on the inputs\n ', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
parser.add_argument('DIG_type_weight', default=0, type=int, help='Create new DIG')
