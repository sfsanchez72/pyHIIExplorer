...
parser = argparse.ArgumentParser(description='###Program to extract properties of HII regions and DIG from cube pip3d###', usage='extract_pipe3d_cl.py name input_file n_hdu_fe n_hdu_ssp n_hdu_sfh n_hdu_index blobs_final diff_points FWHM_MUSE plot def_DIG DIR [--OPTIONAL_ARGUMENTS=*]\nRun with -h for details on the inputs\n ', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
WCS, hdu_HII, hdu_DIG, table_HII, table_DIG = extracting_flux_elines(name, data, hdr_fe, blobs_final, diff_points,  plot=plot)
