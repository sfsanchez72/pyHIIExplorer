...
parser = argparse.ArgumentParser(description='###Program to extract properties of HII regions and DIG from separate input files###', usage='extract_cl.py name input_file_fe input_file_ssp input_file_sfh input_file_index blobs_final diff_points plot def_DIG DIR [--OPTIONAL_ARGUMENTS=*]\nRun with -h for details on the inputs\n ', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
