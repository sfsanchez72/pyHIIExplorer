...
parser.add_argument('DIR', default='nan', type=str, help='Where save outputfiles')
...
dict_DIG_units['DIGREGID'] = 'number'
...
file_table_HII = DIR+"/HII."+name+".flux_elines.table.dat"
file_table_DIG = DIR+"/DIG."+name+".flux_elines.table.dat"

hdu_HII.writeto(file_HII,  overwrite=True)
hdu_DIG.writeto(file_DIG, overwrite=True)

table_HII.write(file_table_HII, overwrite=True,format='ascii.tab')
table_DIG.write(file_table_DIG, overwrite=True, format='ascii.tab')
...
file_table_SSP_HII = DIR+"/HII."+name+'.SSP.table.dat'
file_table_SSP_DIG = DIR+"/DIG."+name+'.SSP.table.dat'

table_SSP_HII.write(file_table_SSP_HII, overwrite=True, format='ascii.tab')
table_SSP_DIG.write(file_table_SSP_DIG, overwrite=True, format='ascii.tab')
...
file_table_SFH_HII = DIR+"/HII."+name+'.SFH.table.dat'
file_table_SFH_DIG = DIR+"/DIG."+name+'.SFH.table.dat'

table_SFH_HII.write(file_table_SFH_HII, overwrite=True, format='ascii.tab')
table_SFH_DIG.write(file_table_SFH_DIG, overwrite=True, format='ascii.tab')
...
file_table_INDEX_HII = DIR+"/HII."+name+'.INDEX.table.dat'
file_table_INDEX_DIG = DIR+"/DIG."+name+'.INDEX.table.dat'

table_INDEX_HII.write(file_table_INDEX_HII, overwrite=True, format='ascii.tab')
table_INDEX_DIG.write(file_table_INDEX_DIG, overwrite=True, format='ascii.tab')
